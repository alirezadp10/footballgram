...
$(document).ready(function () {
  __webpack_require__(/*! ../plugins/ketchup/jquery.ketchup.all.min */ "./resources/plugins/ketchup/jquery.ketchup.all.min.js");
...
/***/ "./resources/plugins/ketchup/jquery.ketchup.all.min.js":
/*!*************************************************************!*\
  !*** ./resources/plugins/ketchup/jquery.ketchup.all.min.js ***!
  \*************************************************************/
/*! no static exports found */
...
(function (g) {
  g.ketchup = {
    ...
    validations: {},
    helpers: {},
    validation: function validation(b, c, d, h) {
      var j;
      if (typeof c == "function") c = c;else {
        j = c;
        c = d;
      }
      this.validations[b] = {
    ...
    message: function message(b, c) {
      this.addMessage(b, c);
      return this;
    },
    messages: function messages(b) {
      for (name in b) {
        this.addMessage(name, b[name]);
      }

      return this;
    },
    addMessage: function addMessage(b, c) {
      if (this.validations[b]) this.validations[b].message = c;
    },
    helper: function helper(b, c) {
      this.helpers[b] = c;
      return this;
    },
    ...
    initFields: function initFields(b, c) {
      var d = this,
          h = this.dataNames,
    ...
    callInitFunctions: function callInitFunctions(b, c) {
      var d = c.data(this.dataNames.validations);

      for (i = 0; i < d.length; i++) {
        d[i].init.apply(this.helpers, [b, c]);
      }
    },
    fieldsFromForm: function fieldsFromForm(b) {
      var c = this,
          d = this.options,
          h = this.dataNames,
    ...
    fieldsFromObject: function fieldsFromObject(b, c) {
      var d = this.options,
          h = this.dataNames,
          j = [];
    ...
    mergeEventsString: function mergeEventsString(b, c) {
    ...
    mergeValidationString: function mergeValidationString(b, c) {
      var d = this.options,
    ...
    bindFormSubmit: function bindFormSubmit(b) {
      var c = this;
      b.submit(function () {
        return c.allFieldsValid(b, true);
      });
    },
    allFieldsValid: function allFieldsValid(b, c) {
      var d = this,
          h = true;
    ...
    bindValidationEvent: function bindValidationEvent(b, c) {
      var d = this,
          h = this.options,
          j = this.dataNames,
    ...
    bindValidationEventBridge: function bindValidationEventBridge(b, c) {
      b.bind(c, function () {
        b.trigger("ketchup." + c);
      });
    },
    validateElement: function validateElement(b, c) {
      var d = [],
          h = b.data(this.dataNames.validations),
          j = [c, b, b.val()];

      for (i = 0; i < h.length; i++) {
        h[i].func.apply(this.helpers, j.concat(h[i].arguments)) || d.push(h[i].message);
      }

      c.trigger("fieldIs" + (d.length ? "Invalid" : "Valid"), [c, b]);
      return d.length ? d : true;
    },
    elementIsValid: function elementIsValid(b) {
    ...
    triggerValidationEvents: function triggerValidationEvents(b) {
      for (var c = b.data(this.dataNames.events).split(" "), d = 0; d < c.length; d++) {
        b.trigger("ketchup." + c[d]);
      }
    },
    extractValidations: function extractValidations(b, c) {
    ...
    extractEvents: function extractEvents(b, c) {
      var d = false,
          h = b.indexOf(c + "(");
      if (h != -1) d = b.substr(h + c.length + 1).split(")")[0];
      return d;
    },
    normalizeArray: function normalizeArray(b) {
      var c = [];
    ...
    createErrorContainer: function createErrorContainer(b, c) {
    ...
    showErrorContainer: function showErrorContainer(b, c, d) {
      if (typeof b == "function") {
    ...
    hideErrorContainer: function hideErrorContainer(b, c, d) {
      if (typeof b == "function") {
    ...
    addErrorMessages: function addErrorMessages(b, c, d, h) {
      if (typeof b == "function") {
...
}).validation("minselect", "Select at least {arg1} checkboxes.", function (g, b, c, d) {
...
/***/ 10:
/*!*********************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/js/create-password.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/create-password.js */"./resources/js/create-password.js");
