<div class="container custom-container">
    <div class="row">
                        ...
                        <div class="sp-slide">
                            <a href="{{ $news['newsURL'] }}">
                                <img class="lazyload" style="width: 100%; height: 100%"
                                     data-src="{{ $news['mainImage'] }}"
                                     data-retina="{{ $news['mainImage'] }}" />
                            </a>
                            <div class="sp-caption">{{ $news['concatTitle'] }}</div>
                            @if($news['firstTag'])
        ...
        <div class="col col-12 col-md-6  col-xl-3 order-xl-3 users-most-followed">
            ...
            @foreach($response['usersHaveMustFollower'] as $user)
