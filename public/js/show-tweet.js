...
$(document).ready(function () {
  $(document).on("click", ".post-comment-reply", function () {
    $(".reply-show").slideUp(1000).delay(1000).queue(function () {
      $(this).remove();
    });
    ...
    if ($("meta[name='comment']").attr("content")) {
      ...
      $(this).parent().parent().after("\n                <div class=\"post-compose-comment reply-show post-comment-".concat(commentLevel, "\" style=\"display: none\">\n                    <div class=\"post-compose-comment-container\">\n                        <form method=\"post\" action=\"/posts/comments?post_id=").concat(postID, "&post_type=").concat(postType, "&comment_level=").concat(commentLevel, "&parent_id=").concat(parentID, "\">\n                            <input type=\"hidden\" name=\"_token\" value=\"").concat(csrf, "\">\n                            <textarea name=\"context\" placeholder=\"\u067E\u0627\u0633\u062E \u062E\u0648\u062F \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633\u06CC\u062F ...\"></textarea>\n                            <button type=\"submit\" class=\"btn btn-info\">\u0627\u0631\u0633\u0627\u0644</button>\n                        </form>\n                    </div>\n                </div>\n            "));
    } else {
  ...
  $(".post-comment-toggle").click(function () {
    var dataLevel = parseInt($(this).parent().parent().attr("data-level"));
    var dataStatus = $(this).parent().parent().attr("data-status");
    var nextComment = $(this).parent().parent().next();
    $(this).children().toggleClass("fa-angle-up");
    $(this).children().toggleClass("fa-angle-down");

    if ($(this).children().hasClass("fas fa-angle-up")) {
      $(this).tooltip("hide").attr("data-original-title", "باز کردن").tooltip("show");
      $(this).css({
        "background": "#7D7D7D",
        "color": "#F7F7F7"
      });
    ...
    if ($(this).children().hasClass("fas fa-angle-down")) {
      $(this).tooltip("hide").attr("data-original-title", "بستن").tooltip("show");
      $(this).css({
        "background": "#F7F7F7",
        "color": "#7D7D7D"
      });
    ...
    $.ajax({
      ...
      error: function error(data) {
        if (data.status === 429) {
          ...
          window.alertify.notify("تعداد درخواست های شما از سرور بیش از حد مجاز بوده است. <br> یک دقیقه ی دیگر دوباره تلاش کنید.", "error", 5);
        }
      }
    });
  });
  ...
  $("#delete-post-btn").click(function () {
    ...
    window.alertify.confirm("آیا از حذف این پست مطمئن هستید؟").set("defaultFocus", "لغو").setHeader("هشدار !").set("onok", function () {
          ...
          if (!data.length) {
            $.ajax({
              ...
              success: function success() {
                window.alertify.set("notifier", "position", "bottom-left");
                window.alertify.notify("عملیات با موفقیت انجام شد", "success", 5);
              }
            });
            return;
          }
  ...
  $(".post-instagram-footer").click(function () {
    $this = $(this);
    var offset = $this.find("div").attr("data-offset");
    $.ajax({
      ...
      success: function success(data) {
        ...
        var loop = 0;
        data.forEach(function (item) {
          var first_post_padding = "pr-sm-2";
          ...
          loop++;
          var like = item.isLiked ? 'post-liked' : '';
          var dislike = item.isDisliked ? 'post-disliked' : '';
          $(".post-instagram-body-ajax").find(".row").append("\n                        <div class=\"col-12 col-sm-6 col-md-6 col-lg-2 pt-2 pb-2 pl-0 pl-sm-3 pr-0 ".concat(first_post_padding, "\">\n                            <div class=\"post-instagram-wrapper mt-1\"\n                                 data-post-id=\"").concat(item.id, "\">\n                                <a href=\"").concat(item.url, "\">\n                                    <span class=\"post-layout\"></span>\n                                </a>\n                                <img class=\"post-instagram-img lazyload\"\n                                     src=\"").concat(item.mainPhoto, "\" />\n                                <a href=\"").concat(item.authorUrl, "\" class=\"post-instagram-author\">\n                                    <i class=\"fas fa-pencil-alt\"></i>\n                                    ").concat(item.authorName, "\n                                </a>\n                                <div class=\"post-instagram-like-wrapper\">\n                                    <div class=\"post-instagram-like ").concat(like, "\">\n                                        <span class=\"count-like\">").concat(item.countLike, "</span>\n                                        <i class=\"far fa-thumbs-up\"></i>\n                                    </div>\n                                    <div class=\"post-instagram-dislike ").concat(dislike, "\">\n                                        <span class=\"count-dislike\">").concat(item.countDislike, "</span>\n                                        <i class=\"far fa-thumbs-down\"></i>\n                                    </div>\n                                </div>\n                                <a href=\"").concat(item.url, "\">\n                                    <div class=\"post-instagram-caption\">\n                                        ").concat(item.title, "\n                                    </div>\n                                </a>\n                            </div>\n                        </div>\n                    "));
        });
      ...
      error: function error(data) {
        if (data.status === 429) {
          window.alertify.set("notifier", "position", "bottom-left");
          window.alertify.notify("تعداد درخواست های شما از سرور بیش از حد مجاز بوده است. <br> یک دقیقه ی دیگر دوباره تلاش کنید.", "error", 5).dismissOthers();
        } else {
          window.alertify.set("notifier", "position", "bottom-left");
          window.alertify.notify(data.responseJSON.message, "error", 10).dismissOthers();
        }
      }
    });
  });
  ...
  function infiniteScroll(element, callback) {
    $("".concat(element)).scroll(function () {
      var $this = $(this);
      ...
      if (isScrolledToEnd) {
        if ($("".concat(element)).attr('data-status') !== 'DONE') {
    ...
    $.ajax({
      ...
      error: function error(data) {
        if (data.status === 401) {
          ...
          window.alertify.set("notifier", "position", "bottom-left");
          window.alertify.notify("برای انجام این کار ابتدا ثبت نام کنید", "error", 10);
        }
...
/***/ 3:
/*!****************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/js/show-tweet.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/show-tweet.js */"./resources/js/show-tweet.js");
