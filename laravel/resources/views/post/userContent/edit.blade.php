@extends('layouts.app')
@section('header')
    <title>ویرایش مطلب کاربری - فوتبال گرام</title>
@endsection
@section('styles')
...
@section('content')
    <div class="container custom-container">
        ...
        <div id="smartwizard">
            ...
            <div>
                <form action="{{ route('user-contents.update',$response['slug']) }}"
                      method="post"
                      class="form"
                    ...
                    <div class="steps" id="step-2">
                        <div class="form-group">
                            <label for="main-photo">تصویر :<small> (اختیاری) </small></label>
                            <input type="file"
                                   class="form-control"
                    ...
                    <div class="steps" id="step-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"
                                      name="context"
                                      id="context"
                                      placeholder="متن خود را وارد کنید">{!! $response['context'] !!}</textarea>
                        </div>
                    </div>
                    <div class="steps" id="step-4">
                        <div class="form-group">
                            <button type="submit"
                                    class="btn btn-success">برای به روز رسانی مطلب کلیک کنید
                            </button>
                        </div>
                    </div>
                </form>
