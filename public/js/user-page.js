...
$(document).ready(function () {
  ...
  var tabCount = $(".instagram-nav").children().length;
  $(".instagram-nav").children().css({
    width: "".concat(100 / tabCount, "%")
  });
  $(".instagram-tab-content").children().first().addClass("show active");
  var firstTab = $(".instagram-nav .active").attr("aria-controls");
  var time_line_received = 0;
  ...
  var news_active = $("div[aria-controls = '#nav-news']").hasClass("active");
  var news_clicked = false;
  $(".news").click(function () {
  ...
  var user_contents_active = $("div[aria-controls = '#nav-user-contents']").hasClass("active");
  var user_contents_clicked = false;
        ...
        success: function success(data) {
          if (data.comments.length) {
            ...
            data.comments.forEach(function (item) {
              var post_comment_liked = item.isLiked === true ? "post-comment-liked" : "";
              var post_comment_disliked = item.isDisliked === true ? "post-comment-disliked" : "";
              $("#comments-wrapper").append("\n                                    <div class=\"col-12 p-0\">\n                                        <div class=\"post-comment\"\n                                             data-id=\"".concat(item.id, "\"\n                                             data-level=\"").concat(item.level, "\">\n                                            <div class=\"post-comment-body\">\n                                                ").concat(item.context, "\n                                            </div>\n                                            <div class=\"post-comment-like-parent\">\n                                                <span class=\"post-comment-like-wrapper\">\n                                                    <button class=\"post-comment-like-button ").concat(post_comment_liked, "\">\n                                                        <i class=\"far fa-thumbs-up\"></i>\n                                                    </button>\n                                                    <span class=\"post-comment-like-count ").concat(post_comment_liked, "\">\n                                                        ").concat(item.like, "\n                                                    </span>\n                                                </span>\n                                                <span class=\"post-comment-dislike-wrapper\">\n                                                    <button class=\"post-comment-dislike-button ").concat(post_comment_disliked, "\">\n                                                        <i class=\"far fa-thumbs-down\"></i>\n                                                    </button>\n                                                    <span class=\"post-comment-dislike-count ").concat(post_comment_disliked, "\">\n                                                        ").concat(item.dislike, "\n                                                    </span>\n                                                </span>\n                                                <a href=\"").concat(item.url, "\">\n                                                    <div class=\"post-comment-view\">\n                                                            <i class=\"fas fa-eye\"></i>\n                                                    </div>\n                                                </a>\n                                            </div>\n\n                                        </div>\n                                    </div>                                    \n                                "));
            });
          } else {
      ...
      success: function success(data) {
        if (data.timeLine.length) {
          ...
          data.timeLine.forEach(function (item) {
            var like = item.isLiked ? 'post-liked' : '';
            var dislike = item.isDisliked ? 'post-disliked' : '';
            $("#time-line-wrapper").append("\n                                <div class=\"col-12 col-md-6 col-lg-4\">\n                                    <div class=\"post-instagram-wrapper\">\n                                        <a href=\"".concat(item.url, "\">\n                                            <span class=\"post-layout\"></span>\n                                        </a>\n                                        <img src=\"").concat(item.mainPhoto, "\"\n                                             class=\"post-instagram-img lazyload\" />\n                                        <a href=\"").concat(item.authorUrl, "\" class=\"post-instagram-author\">\n                                            <i class=\"fas fa-pencil-alt\"></i> ").concat(item.authorName, "\n                                        </a>\n                                        <div class=\"post-instagram-like-wrapper\">\n                                            <div class=\"post-instagram-like ").concat(like, "\">\n                                                ").concat(item.countLike, " <i class=\"far fa-thumbs-up\"></i>\n                                            </div>\n                                            <div class=\"post-instagram-dislike ").concat(dislike, "\">\n                                                ").concat(item.countDislike, " <i class=\"far fa-thumbs-down\"></i>\n                                            </div>\n                                        </div>\n                                        <a href=\"").concat(item.url, "\">\n                                            <div class=\"post-instagram-caption\">\n                                                ").concat(item.title, "\n                                            </div>\n                                        </a>\n                                    </div>\n                                </div>                                    \n                            "));
          });
        } else {
          $(".more-time-line").parent().remove();
        }
...
/***/ 5:
/*!***************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/js/user-page.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/alirezadp10/Desktop/footballgram/resources/js/user-page.js */"./resources/js/user-page.js");
