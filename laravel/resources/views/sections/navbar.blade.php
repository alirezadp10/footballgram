    ...
    @auth
        <a class="navbar-user-avatar-sm hide-in-md hide-in-lg hide-in-xl"
           ...
           aria-expanded="false">
            ...
            <span class="hide-in-xs">{{ $response['navbar']['name'] }}</span>
            <img src="{{ $response['navbar']['avatar'] }}"
                 class="img-fluid">
            <span data-to-farsi
                  @if(!$response['navbar']['notifications_count'])
                  style="background: inherit"
                  @endif
                  class="notifications-badge-side-avatar-sm notifications-badge-counter">
                  @if($response['navbar']['notifications_count'])
                    {{ $response['navbar']['notifications_count'] }}
                @endif
            </span>
        </a>
                    ...
                    <div class="dropdown-menu navbar-user-dropdown-lg">
                        ...
                        <a class="dropdown-item notifications"
                           id="notifications-button-lg">
                            <i class="far fa-bell"></i>اعلانات
                            <span @if(!$response['navbar']['notifications_count'])
                                  style="background: inherit"
                                  @endif
                                  @if($response['navbar']['notifications_count'])
                                  {{ $response['navbar']['notifications_count'] }}
